      ...
      <el-form :inline="true" v-model="form">
        ...
        <el-form-item label="语言" class="filter-item">
          <el-select v-model="form.lang" >
            <el-option v-for="lang in configLangs" :key="lang.id" :value="lang.id" :label="lang.description" />
            <el-option value="" label="任意语言" />
          </el-select>
        </el-form-item>
        <el-form-item label="评测结果" class="filter-item">
          <el-select v-model="form.verdict" >
            <el-option v-for="verdict in configVerdicts" :key="verdict.id" :value="verdict.id" :label="verdict.description" />
