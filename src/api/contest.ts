...
export const apiContestFinished = async (request: ContestFinishedRequest) => {
  const data = (await axios.post<ContestFinishedResponse>('/contest/finished', request, {} as ReisenAxiosConfig)).data
...
export const apiContestRecent = async (request: ContestRecentRequest) => {
  ...
  const data = (await axios.post<ContestRecentResponse>('/contest/recent', request, {} as ReisenAxiosConfig)).data
...
export const apiContest = async (request: ContestRequest) => {
  const data = (await axios.post<ContestResponse>('/contest', request, {} as ReisenAxiosConfig)).data
...
export const apiRanking = async (request: RankingRequest) => {
  return (
    await axios.post<RankingResponse>('/contest/ranking', request, {} as ReisenAxiosConfig)
  ).data
}
